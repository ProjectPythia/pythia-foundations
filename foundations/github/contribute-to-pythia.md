...
We will follow the [forking workflow](#forking-workflow) described in the previous section of this tutorial, assuming `pythia-foundations` has already been forked:
...
```{image} ../../images/GitHubContrJupyterLab.png
:alt: Notebook in JupyterLab
```
...
```{image} ../../images/GitHubContrFork.png
...
```{image} ../../images/GitHubContrPR.png
:alt: GitHub PR Creation
```
...
```{image} ../../images/GitHubContrChecks.png
:alt: GitHub Checks
```
