...
Jupyter let us create expressive, interactive computational narratives, and execute them on a wide variety of computing platforms from a local laptop to a remote supercomputer. 
